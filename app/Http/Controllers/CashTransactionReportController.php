...
class CashTransactionReportController extends Controller
{
    ...
    public function __invoke(): View
    {
        ...
        return view('reports.index', [
            'sum_this_day' => $this->cashTransactionReportRepository->sum('amount', 'this_day'),
            'sum_this_week' => $this->cashTransactionReportRepository->sum('amount', 'this_week'),
            'sum_this_month' => $this->cashTransactionReportRepository->sum('amount', 'this_month'),
            'sum_this_year' => $this->cashTransactionReportRepository->sum('amount', 'this_year'),
