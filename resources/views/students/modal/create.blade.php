					...
					<div class="row">
						...
						<div class="col-sm-6 col-md-6">
							<div class="mb-3">
								...
								<input type="number" class="form-control @error('phone_number') is-invalid @enderror" name="phone_number" id="phone_number" value="{{ old('phone_number') }}" placeholder="Masukkan nomor handphone..">
					...
					<div class="row">
						<div class="col-sm-12 col-md-12">
							...
							<div class="input-group mb-3">
								<input type="number" class="form-control @error('school_year_start') is-invalid @enderror" name="school_year_start" placeholder="Masukkan awal tahun ajaran.." value="{{ date('Y') - 3 }}">
								<span class="input-group-text">-</span>
								<input type="number" class="form-control @error('school_year_end') is-invalid @enderror" name="school_year_end" placeholder="Masukkan akhir tahun ajaran.." value="{{ date('Y') }}">
							</div>
						</div>
					</div>
